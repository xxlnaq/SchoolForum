...
public class CacheUtils {
    ...
    public <T> T takeFromCache(String key,Class<T> dataType){
        ...
        return JSONObject.parseObject(s, dataType);//JSONObject.parseObject(s).to(dataType)
    }
    //JSONObject.parseObject是将字符串转换为JSONObject 仅支持 字符串。
    //JSONObject.parseObjects是将对象或者字符串转换为JSONObject 支持 字符串和对象。
