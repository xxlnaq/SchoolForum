...
get('api/user/info',(data)=>{
  /**
   * email: "1438340069@qq.com"
   * registerTime: "2025-05-11T09:18:51.000+00:00"
   * role: "user"
   * username: "admin"
   */
    store.user=data
      ...
      <el-header class="main-content-header">
       ...
       <div style="flex: 1;padding: 0 20px ; text-align: center" >
           <el-input   v-model="searchInput.text"
               style="width: 100% ;max-width: 500px" placeholder="搜索论坛相关内容....">
             <template #prefix>
        ...
        <div class="user-info">
          <el-popover placement="bottom" :width="350" trigger="click">
            ...
            <el-empty :image-size="80" description="暂时没有未读消息喔~" v-if="!notification.length"/>
            ...
            <div style="margin-top: 10px">
              <el-button size="small" type="info" :icon="Check" @click="deleteAllNotification"
                         style="width: 100%" plain>清楚全部未读消息</el-button>
            </div>
          </el-popover>
           <div class="profile">
